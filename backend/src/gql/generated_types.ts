...
export type BookResolvers<ContextType = any, ParentType extends ResolversParentTypes['Book'] = ResolversParentTypes['Book']> = ResolversObject<{
  ...
  pagesRead?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  insertBook?: Resolver<ResolversTypes['Book'], ParentType, ContextType, RequireFields<MutationInsertBookArgs, 'input'>>;
  updateBookInfo?: Resolver<Maybe<ResolversTypes['Book']>, ParentType, ContextType, RequireFields<MutationUpdateBookInfoArgs, 'title'>>;
}>;
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  bookByAuthor?: Resolver<Array<ResolversTypes['Book']>, ParentType, ContextType, RequireFields<QueryBookByAuthorArgs, 'author'>>;
  bookByTitle?: Resolver<ResolversTypes['Book'], ParentType, ContextType, RequireFields<QueryBookByTitleArgs, 'title'>>;
}>;
